    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-gray-300 text-sm md:text-base max-w-sm">
          I&apos;ve been working on building amazing projects. Here&apos;s a
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-gray-900 border border-purple-500/30 flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-purple-600 border border-purple-400 p-2" />
              </div>
